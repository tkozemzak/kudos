        ...
        <Layout>
            <div className="h-full justify-center items-center flex flex-col gap-y-4">
                <button
                    ...
                    className="absolute top-8 right-8 rounded-xl bg-yellow-300 font-semibold text-blue-600 px-3 py-3 transition duration-300 ease-in-out hover:bg-yellow-400 hover:-translate-y-1">
